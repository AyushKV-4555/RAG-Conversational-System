...
import uuid
from backend_rag_tool import chatbot, ingest_pdf, retrieve_all_threads, thread_document_metadata
...
if "ingested_docs" not in st.session_state:   # Each chat thread remembers its own PDFs
